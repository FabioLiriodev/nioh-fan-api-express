...
const service = __importStar(require("../services/players-service"));
const getPlayers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const httpResponse = yield service.getPlayerService();
    res.status(httpResponse.statusCode).json(httpResponse.body);
});
exports.getPlayers = getPlayers;
const getPlayerById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    const httpResponse = yield service.getPlayerByIdService(id);
    res.status(httpResponse.statusCode).json(httpResponse.body);
});
